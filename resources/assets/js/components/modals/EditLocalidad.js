...
class EditLocalidad extends Component{
	constructor(props){
		super(props);
		this.hideModal = this.hideModal.bind(this);
		this.editLocalidad = this.editLocalidad.bind(this);
	...
	editLocalidad(e){
		...
		this.props.editarLocalidad(provincia, nombre);
	...
	render(){
		return(
			<div className="modal hide-modal" id="m-edit-localidad">
				<div className="content-modal">
					<h3>Editar datos de la localidad</h3>
					<div className="btn-foot">
						<form action="" onSubmit={this.editLocalidad} className="edit-form" >
